...
= 5.1.6 =
- Tweaked the newly added feature's code to be PHP 7.4 compatible.
...
- File url option in the 'Product Box' block has been repositioned.
- Added a new option to 'Resend Sale Notification Email' in order details page.
